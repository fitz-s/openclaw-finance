...
def compile_entry(
    *,
    ...
    return {
        ...
        'campaign_live_board_hash': hash_text(product_report.get('discord_live_board_markdown')),
        'campaign_scout_board_hash': hash_text(product_report.get('discord_scout_board_markdown')),
        'campaign_risk_board_hash': hash_text(product_report.get('discord_risk_board_markdown')),
        'campaign_board_ref': product_report.get('campaign_board_ref'),
