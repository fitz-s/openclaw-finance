...
DEPENDENCIES = {
    ...
    'source_registry_schema': WORKSPACE / 'schemas' / 'source-registry-record.schema.json',
    'source_health_schema': WORKSPACE / 'schemas' / 'source-health.schema.json',
    'source_registry': SERVICE / 'config' / 'source-registry.json',
    'source_health_compiler': SERVICE / 'source_health' / 'compiler.py',
